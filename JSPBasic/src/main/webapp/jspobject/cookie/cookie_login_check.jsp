...
<%
	...
	// 비밀번호는 "1111"인 경우만 허용하겠습니다.(추후 DB데이터로 로그인처리하는법 배울거임)
	// 조건문을 이용해주시면 되는데
	...
	if(strId.equals("abc1234")){ // 아이디가 있는경우
		if(strPw.equals("1111")){ // 비번도 맞는경우
			// 로그인 성공시 쿠키를 생성하고, 로그인 완료 페이지에서는 해당 쿠키를 확인하게 만들어서 로그인 여부를 감지합니다.
			// 쿠키 생성(쿠키 이름은 login.id, 값은 abc1234) // 두번째 단어부터 대문자로하는 카멜케이스
