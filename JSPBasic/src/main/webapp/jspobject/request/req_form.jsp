...
<body>
	...
	여 닫는 부분 사이에 input 태그를 이용해 보낼 데이터 양식을 지정할 수 있습니다. -->
	<form action="http://localhost:8181/JSPBasic/jspobject/request/req_bmi.jsp" method="post">
		...
		오렌지 : <input type="text" name="orange"/> <br/>
		딸기 : <input type="text" name="strawberry"/> <br/>
		<input type="submit">
	</form>
</body>
</html>