...
<%
	...
	// 임의로 받아올 수 있는 request.getParameter("변수명")을 작성해주시고 변수 c에 저장한후 body에 출력해주세요.
	String c = request.getParameter("mango");
	String d = request.getParameter("orange");
	String e = request.getParameter("strawberry");
	%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	mango로 전송된 데이터 : <%= c %><br/>
	orange로 전송된 데이터 : <%= d %><br/>
	strawberry로 전송된 데이터 : <%= e %> <br/>
</body>
</html>