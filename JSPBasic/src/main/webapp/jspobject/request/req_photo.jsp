...
<body>
	...
	테이블을 이용해 사진 제목, 체크박스를 만들어 주세요.
	그리고 아래에 제출 버튼을 "그림 보러 가기" 로 적어주시고
	해당 버튼을 눌렀을때 req_photo_result에 어떤 그림을 선택했는지
	체크박스로 구분해주시고, 구분한 그림에 맞는 사진이 결과페이지에 나오도록
	if~else문을 구성해주세요.
	그림파일은 <img src="파일명"> 을 이용해 출력가능합니다. --%>
	...
	<table class="table">
		...
		<tr>
			<td>아기 고양이가 앞을 보고 있는 모습입니다.</td>
			<td><input type="radio" name="photo" value="1번그림"> &nbsp;</td>
		</tr>
		<tr>
			<td>아기 고양이가 옆을 보고 있는 모습입니다.</td>
			<td><input type="radio" name="photo" value="2번그림" >&nbsp;</td>	
		</tr>	
	</table>
